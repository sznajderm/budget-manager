...
import { z } from "zod";
import { getExpenseSummary, SummaryCommandSchema } from "../../../../../lib/services/expense-summary.service";
  ...
  try {
    ...
    try {
      ...
      if (error instanceof Error) {
        ...
        if (error.message.includes("Failed to retrieve expense summary") || error.message.includes("database error")) {
